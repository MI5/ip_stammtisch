...
if (isset($b))
{
  ...
  if ($b == 0)
  {
    ...
    echo "<form name=\"beitr\" action=\"forum.php\" method=\"post\">";
    echo "<table>";
    echo "<tr>";
    ...
    echo "</tr><tr>";
    echo "  <td>eMail:</td><td><input name=\"f_email\" size=\"30\" maxlength=\"30\"> (Optional)</td>";
    echo "</tr><tr>";
    echo "  <td>Betreff:</td><td><input name=\"f_topic\" size=\"30\" maxlength=\"200\"></td>";
    echo "</tr><tr>";
    echo "  <td>Clanintern:</td><td><input type=\"checkbox\" value=\"1\" name=\"f_intern\"></td></tr></table>";
  ...
  else
  {
    ...
    if ($daten[intern] == 1)
    {
      ...
      else
      {
        ...
        {
          echo "Passwort zur&uuml;ckgewiesen!<br><br><a href=\"forum.php?b=$b\">Nochmal versuchen</a><br><br>";
          $in_pw = 1;
        }
      }
    }
...
<?
  if (isset($b))
  {
    if ($b != 0)
    {
      if ($in_pw != 1)
      {
          echo "<a href=\"forum.php?b=0\">Beitrag posten</a><br><br>";
      }
    }
  }
  else
...
while($daten = mysql_fetch_array($abfrage_id))
{
  ...
  if ($daten['intern'] == 1)
  {
    ...
    if ($style == "")
      echo "<a href=\"forum.php?b=$daten[id]\">";
    echo "$daten[topic]";
    if ($style == "")
      echo "</a>";
    echo "</td>\n";
  ...
  echo "  <td align=\"right\">";
  $d = (string) $daten['datum'];
  echo "$d[8]$d[9].$d[5]$d[6].$d[0]$d[1]$d[2]$d[3]&nbsp;$d[11]$d[12]:$d[14]$d[15]";
  echo "</td>\n</tr>\n";
}
?>
</table>
